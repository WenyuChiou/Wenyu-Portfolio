...
class ParticleNetwork {
    constructor(canvasId) {
        ...
        // Config
        this.config = {
            particleColor: 'rgba(15, 23, 42, 0.2)', // Dark Navy for Light Mode
            lineColor: 'rgba(14, 165, 233, 0.15)',  // Sky Blue for Light Mode
            particleAmount: 20, // Reduced from 40 for performance
            defaultSpeed: 0.5,
            variantSpeed: 1,
            linkRadius: 150
        };
